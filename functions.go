...
func sendSpoofedTalkDemo(chatJID types.JID, spoofedJID types.JID, toGender string, language string, spoofedFile string) {
	...
	msgmap["ar"]["generic"][0] = "اهلا..."
	msgmap["ar"]["generic"][1] = "يحسام..."
	msgmap["ar"]["generic"][2] = "❤️❤️❤️❤️❤️"
	msgmap["ar"]["generic"][3] = "بجرب..."
	msgmap["ar"]["generic"][4] = "حاجه جديده..."
	msgmap["ar"]["generic"][5] = "اى رايك..."
	msgmap["ar"]["generic"][6] = "هكر اخلاقى..."
